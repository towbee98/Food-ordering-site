...
router.get('/orders', function(req, res, next) {
    ...
    var restaurant = sess.restaurant;
    var ss = select * from RESTUARANT_MENUs_ORDERS orders JOIN RESTUARANT_MENUS menu ON orders.MENU = menu.RESTUARANT_MENU_ID AND  orders.ORDERDATE>='2017-05-18'  and orders.ORDERDATE<='2017-05-18' and 1=1";
    console.log(ss);
    //connection.query("select * from RESTUARANT_MENUs_ORDERS orders JOIN RESTUARANT_MENUS menu ON orders.MENU = menu.RESTUARANT_MENU_ID AND menu.RESTUARANT_ID = ?",[restaurant], function(err, rows) {
	 connection.query("select * from RESTUARANT_MENUs_ORDERS orders JOIN RESTUARANT_MENUS menu ON orders.MENU = menu.RESTUARANT_MENU_ID AND  orders.ORDERDATE>='2017-05-18'  and orders.ORDERDATE<='2017-05-18' and menu.RESTUARANT_ID = ?",[restaurant], function(err, rows) {
